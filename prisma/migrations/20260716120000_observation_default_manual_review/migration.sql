...
INSERT INTO "new_Observation" ("createdAt", "description", "evidenceCapturedAt", "evidencePath", "gpsLat", "gpsLng", "humanCheckStatus", "id", "impactScore", "issueClusterKey", "issueType", "roadId", "severityScore", "source") SELECT "createdAt", "description", "evidenceCapturedAt", "evidencePath", "gpsLat", "gpsLng", "humanCheckStatus", "id", "impactScore", "issueClusterKey", "issueType", "roadId", "severityScore", "source" FROM "Observation";
